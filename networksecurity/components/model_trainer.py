...
import mlflow
import dagshub
dagshub.init(repo_owner='Mehta-Kartik', repo_name='networksecurities', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        ...
        #Let's get the best model name from the dict
        ...
        ## We will be adding a new function to track the mlflow 
